...
final List<Scenario> allScenarios = [
  ...
  Scenario(
    [
      ...
      "Would you just climb it once and get the gem?",
  ...
  Scenario([
    ...
    "Would you like to look around for the owner and return it?",
    "You could also trade it to someone for something valuable.",
    "What will it be?"
  ], [
    Option("Help someone by returning the tool.",
  ...
  "What do you think?"],
      [
    Option("Mine for gems",
        ["Well then, pick up your pick and wish for luck!",
        "...",
        "Over there, something's shining!",
        "Looks like you've found your gem!",
        "Way to go!"],
        player, 1.0,
        achiever, 0.0),
    Option("Socialize with the other climbers",
        ["Might as well chat a bit while resting!",
        "The other climbers have some good tips for the road ahead as well.",
